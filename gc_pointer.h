...
private:
    ...
    //doubly linked list of data type ptrDetails
    ...
    */
    ...
    //basically it returns list refcontainer.begin() we have to pass the object
...
T *Pointer<T, size>::operator=(T *t){
    ...
    // decrease the refcount of the current memory block returns pointer details object
    p = findPtrInfo(addr);
    if (p->refcount) {
        p->refcount--;
    }
